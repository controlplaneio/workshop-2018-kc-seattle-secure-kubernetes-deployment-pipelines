...
```bash
docker build . -t 192.168.99.100:30003/library/demo-api:vulnerable
docker push 192.168.99.100:30003/library/demo-api:vulnerable
```
...
```bash
docker build . -t 192.168.99.100:30003/library/demo-api:secure
docker push 192.168.99.100:30003/library/demo-api:secure
```
...
If you go to your browser and enter your cluster IP with the port defined in the yaml, `http://192.168.99.100:30009/` you will see the demo api has been deployed successfully.
